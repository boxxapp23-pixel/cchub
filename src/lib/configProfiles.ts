...
const PRESETS: Record<StructuredConfigTool, ConfigPreset[]> = {
  claude: [
    ...
    // === 第三方 ===
    { id: "claude-packycode", toolId: "claude", name: "PackyCode", websiteUrl: "https://www.packyapi.com", apiKeyUrl: "https://www.packyapi.com/register", category: "third_party", badge: "第三方", baseUrl: "https://www.packyapi.com", model: "", authField: "ANTHROPIC_AUTH_TOKEN", endpointCandidates: ["https://www.packyapi.com", "https://api-slb.packyapi.com"] },
    { id: "claude-cubence", toolId: "claude", name: "Cubence", websiteUrl: "https://cubence.com", apiKeyUrl: "https://cubence.com/signup", category: "third_party", badge: "第三方", baseUrl: "https://api.cubence.com", model: "", authField: "ANTHROPIC_AUTH_TOKEN", endpointCandidates: ["https://api.cubence.com", "https://api-cf.cubence.com", "https://api-dmit.cubence.com"] },
    { id: "claude-aigocode", toolId: "claude", name: "AIGoCode", websiteUrl: "https://aigocode.com", apiKeyUrl: "https://aigocode.com", category: "third_party", badge: "第三方", baseUrl: "https://api.aigocode.com", model: "", authField: "ANTHROPIC_AUTH_TOKEN", endpointCandidates: ["https://api.aigocode.com"] },
    { id: "claude-rightcode", toolId: "claude", name: "RightCode", websiteUrl: "https://www.right.codes", apiKeyUrl: "https://www.right.codes/register", category: "third_party", badge: "第三方", baseUrl: "https://www.right.codes/claude", model: "", authField: "ANTHROPIC_AUTH_TOKEN" },
    { id: "claude-aicodemirror", toolId: "claude", name: "AICodeMirror", websiteUrl: "https://www.aicodemirror.com", apiKeyUrl: "https://www.aicodemirror.com/register", category: "third_party", badge: "第三方", baseUrl: "https://api.aicodemirror.com/api/claudecode", model: "", authField: "ANTHROPIC_AUTH_TOKEN", endpointCandidates: ["https://api.aicodemirror.com/api/claudecode", "https://api.claudecode.net.cn/api/claudecode"] },
    { id: "claude-aicoding", toolId: "claude", name: "AICoding", websiteUrl: "https://aicoding.sh", apiKeyUrl: "https://aicoding.sh", category: "third_party", badge: "第三方", baseUrl: "https://api.aicoding.sh", model: "", authField: "ANTHROPIC_AUTH_TOKEN", endpointCandidates: ["https://api.aicoding.sh"] },
    { id: "claude-crazyrouter", toolId: "claude", name: "CrazyRouter", websiteUrl: "https://www.crazyrouter.com", apiKeyUrl: "https://www.crazyrouter.com/register", category: "third_party", badge: "第三方", baseUrl: "https://crazyrouter.com", model: "", authField: "ANTHROPIC_AUTH_TOKEN", endpointCandidates: ["https://crazyrouter.com"] },
    { id: "claude-sssaicode", toolId: "claude", name: "SSSAiCode", websiteUrl: "https://www.sssaicode.com", apiKeyUrl: "https://www.sssaicode.com/register", category: "third_party", badge: "第三方", baseUrl: "https://node-hk.sssaicode.com/api", model: "", authField: "ANTHROPIC_AUTH_TOKEN", endpointCandidates: ["https://node-hk.sssaicode.com/api", "https://claude2.sssaicode.com/api", "https://anti.sssaicode.com/api"] },
    { id: "claude-micu", toolId: "claude", name: "Micu", websiteUrl: "https://www.openclaudecode.cn", apiKeyUrl: "https://www.openclaudecode.cn/register", category: "third_party", badge: "第三方", baseUrl: "https://www.openclaudecode.cn", model: "", authField: "ANTHROPIC_AUTH_TOKEN", endpointCandidates: ["https://www.openclaudecode.cn"] },
    { id: "claude-xcode", toolId: "claude", name: "X-Code API", websiteUrl: "https://x-code.cc", apiKeyUrl: "https://x-code.cc", category: "third_party", badge: "第三方", baseUrl: "https://x-code.cc", model: "", authField: "ANTHROPIC_AUTH_TOKEN", endpointCandidates: ["https://x-code.cc"] },
    { id: "claude-ctok", toolId: "claude", name: "CTok.ai", websiteUrl: "https://ctok.ai", apiKeyUrl: "https://ctok.ai", category: "third_party", badge: "第三方", baseUrl: "https://api.ctok.ai", model: "", authField: "ANTHROPIC_AUTH_TOKEN" },
    // === 云厂商 ===
  ...
  codex: [
    ...
    // === 第三方 ===
    { id: "codex-packycode", toolId: "codex", name: "PackyCode", websiteUrl: "https://www.packyapi.com", apiKeyUrl: "https://www.packyapi.com/register", category: "third_party", badge: "第三方", baseUrl: "https://www.packyapi.com/v1", model: "gpt-5.4", codexWireApi: "responses", codexReasoningEffort: "high", endpointCandidates: ["https://www.packyapi.com/v1", "https://api-slb.packyapi.com/v1"] },
    { id: "codex-cubence", toolId: "codex", name: "Cubence", websiteUrl: "https://cubence.com", apiKeyUrl: "https://cubence.com/signup", category: "third_party", badge: "第三方", baseUrl: "https://api.cubence.com/v1", model: "gpt-5.4", codexWireApi: "responses", codexReasoningEffort: "high", endpointCandidates: ["https://api.cubence.com/v1", "https://api-cf.cubence.com/v1"] },
    { id: "codex-aigocode", toolId: "codex", name: "AIGoCode", websiteUrl: "https://aigocode.com", apiKeyUrl: "https://aigocode.com", category: "third_party", badge: "第三方", baseUrl: "https://api.aigocode.com", model: "gpt-5.4", codexWireApi: "responses", codexReasoningEffort: "high", endpointCandidates: ["https://api.aigocode.com"] },
    { id: "codex-rightcode", toolId: "codex", name: "RightCode", websiteUrl: "https://www.right.codes", apiKeyUrl: "https://www.right.codes/register", category: "third_party", badge: "第三方", baseUrl: "https://right.codes/codex/v1", model: "gpt-5.4", codexWireApi: "responses", codexReasoningEffort: "high" },
    { id: "codex-aicodemirror", toolId: "codex", name: "AICodeMirror", websiteUrl: "https://www.aicodemirror.com", apiKeyUrl: "https://www.aicodemirror.com/register", category: "third_party", badge: "第三方", baseUrl: "https://api.aicodemirror.com/api/codex/backend-api/codex", model: "gpt-5.4", codexWireApi: "responses", codexReasoningEffort: "high", endpointCandidates: ["https://api.aicodemirror.com/api/codex/backend-api/codex", "https://api.claudecode.net.cn/api/codex/backend-api/codex"] },
    { id: "codex-aicoding", toolId: "codex", name: "AICoding", websiteUrl: "https://aicoding.sh", apiKeyUrl: "https://aicoding.sh", category: "third_party", badge: "第三方", baseUrl: "https://api.aicoding.sh", model: "gpt-5.4", codexWireApi: "responses", codexReasoningEffort: "high", endpointCandidates: ["https://api.aicoding.sh"] },
    { id: "codex-crazyrouter", toolId: "codex", name: "CrazyRouter", websiteUrl: "https://www.crazyrouter.com", apiKeyUrl: "https://www.crazyrouter.com/register", category: "third_party", badge: "第三方", baseUrl: "https://crazyrouter.com/v1", model: "gpt-5.4", codexWireApi: "responses", codexReasoningEffort: "high", endpointCandidates: ["https://crazyrouter.com/v1"] },
    { id: "codex-sssaicode", toolId: "codex", name: "SSSAiCode", websiteUrl: "https://www.sssaicode.com", apiKeyUrl: "https://www.sssaicode.com/register", category: "third_party", badge: "第三方", baseUrl: "https://node-hk.sssaicode.com/api/v1", model: "gpt-5.4", codexWireApi: "responses", codexReasoningEffort: "high", endpointCandidates: ["https://node-hk.sssaicode.com/api/v1", "https://claude2.sssaicode.com/api/v1"] },
    { id: "codex-micu", toolId: "codex", name: "Micu", websiteUrl: "https://www.openclaudecode.cn", apiKeyUrl: "https://www.openclaudecode.cn/register", category: "third_party", badge: "第三方", baseUrl: "https://www.openclaudecode.cn/v1", model: "gpt-5.4", codexWireApi: "responses", codexReasoningEffort: "high", endpointCandidates: ["https://www.openclaudecode.cn/v1"] },
    { id: "codex-xcode", toolId: "codex", name: "X-Code API", websiteUrl: "https://x-code.cc", apiKeyUrl: "https://x-code.cc", category: "third_party", badge: "第三方", baseUrl: "https://x-code.cc/v1", model: "gpt-5.4", codexWireApi: "responses", codexReasoningEffort: "high", endpointCandidates: ["https://x-code.cc/v1"] },
    { id: "codex-ctok", toolId: "codex", name: "CTok.ai", websiteUrl: "https://ctok.ai", apiKeyUrl: "https://ctok.ai", category: "third_party", badge: "第三方", baseUrl: "https://api.ctok.ai/v1", model: "gpt-5.4", codexWireApi: "responses", codexReasoningEffort: "high", endpointCandidates: ["https://api.ctok.ai/v1"] },
    // === 自定义 ===
  ...
  gemini: [
    ...
    // === 第三方 ===
    { id: "gemini-packycode", toolId: "gemini", name: "PackyCode", websiteUrl: "https://www.packyapi.com", apiKeyUrl: "https://www.packyapi.com/register", category: "third_party", badge: "第三方", baseUrl: "https://www.packyapi.com", model: "gemini-3.1-pro", endpointCandidates: ["https://api-slb.packyapi.com", "https://www.packyapi.com"] },
    { id: "gemini-cubence", toolId: "gemini", name: "Cubence", websiteUrl: "https://cubence.com", apiKeyUrl: "https://cubence.com/signup", category: "third_party", badge: "第三方", baseUrl: "https://api.cubence.com", model: "gemini-3.1-pro", endpointCandidates: ["https://api.cubence.com/v1", "https://api-cf.cubence.com/v1"] },
    { id: "gemini-aigocode", toolId: "gemini", name: "AIGoCode", websiteUrl: "https://aigocode.com", apiKeyUrl: "https://aigocode.com", category: "third_party", badge: "第三方", baseUrl: "https://api.aigocode.com", model: "gemini-3.1-pro", endpointCandidates: ["https://api.aigocode.com"] },
    { id: "gemini-aicodemirror", toolId: "gemini", name: "AICodeMirror", websiteUrl: "https://www.aicodemirror.com", apiKeyUrl: "https://www.aicodemirror.com/register", category: "third_party", badge: "第三方", baseUrl: "https://api.aicodemirror.com/api/gemini", model: "gemini-3.1-pro", endpointCandidates: ["https://api.aicodemirror.com/api/gemini", "https://api.claudecode.net.cn/api/gemini"] },
    { id: "gemini-aicoding", toolId: "gemini", name: "AICoding", websiteUrl: "https://aicoding.sh", apiKeyUrl: "https://aicoding.sh", category: "third_party", badge: "第三方", baseUrl: "https://api.aicoding.sh", model: "gemini-3.1-pro", endpointCandidates: ["https://api.aicoding.sh"] },
    { id: "gemini-crazyrouter", toolId: "gemini", name: "CrazyRouter", websiteUrl: "https://www.crazyrouter.com", apiKeyUrl: "https://www.crazyrouter.com/register", category: "third_party", badge: "第三方", baseUrl: "https://crazyrouter.com", model: "gemini-3.1-pro", endpointCandidates: ["https://crazyrouter.com"] },
    { id: "gemini-sssaicode", toolId: "gemini", name: "SSSAiCode", websiteUrl: "https://www.sssaicode.com", apiKeyUrl: "https://www.sssaicode.com/register", category: "third_party", badge: "第三方", baseUrl: "https://node-hk.sssaicode.com/api", model: "gemini-3.1-pro", endpointCandidates: ["https://node-hk.sssaicode.com/api", "https://claude2.sssaicode.com/api"] },
    { id: "gemini-ctok", toolId: "gemini", name: "CTok.ai", websiteUrl: "https://ctok.ai", apiKeyUrl: "https://ctok.ai", category: "third_party", badge: "第三方", baseUrl: "https://api.ctok.ai/v1beta", model: "gemini-3.1-pro", endpointCandidates: ["https://api.ctok.ai/v1beta"] },
    // === 聚合 ===
